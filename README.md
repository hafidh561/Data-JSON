...
- Silahkan klik `TEMPLATE_DATA.json` kemudian klik edit

- Lalu isi biodata kalian masing masing

- Copy semua kode template yang kalian isi tadi 

- Buka folder `Yours Data` di repository ini
 kemudian klik titik 3 disamping kanan dan klik `Create New File`

- Beri nama file nya `Namamu.json` dan Pastekan kode Markdown yang tadi sudah di copy
